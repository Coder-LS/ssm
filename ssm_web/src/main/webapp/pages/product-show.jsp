	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="panel panel-default">
				...
				<input type="hidden" class="form-control" placeholder="产品ID" name="productId" value="${product.id}" >
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="产品描述" name="productDesc"
							   value="${product.productDesc}" >
					</div>

					<div class="col-md-2 title">产品状态</div>
					<div class="col-md-4 data">
						<input name="productStatus" value="${product.productStatusStr}" readonly>
					</div>
				</div>

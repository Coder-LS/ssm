					...
					<div class="table-box">
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									<div class="btn-group">
<%--										<button type="button" class="btn btn-default" title="删除" onclick="location.href='${pageContext.request.contextPath}/sysLog/deleteSysLog.do'">--%>
...
<%--										</button>--%>
						...
						<form
								action="${pageContext.request.contextPath}/sysLog/deleteSysLog.do"
								method="post">
							<!--工具栏-->
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							每页显示
							<select class="form-control" value="${pageInfo.pageSize}" id="changePageSize" onchange="changePageSize()">
								<option value="5" <c:if test="${'5' eq pageInfo.pageSize}">selected</c:if>>5</option>
								<option value="10" <c:if test="${'10' eq pageInfo.pageSize}">selected</c:if>>10</option>
								<option value="15" <c:if test="${'15' eq pageInfo.pageSize}">selected</c:if>>15</option>
								<option value="20" <c:if test="${'20' eq pageInfo.pageSize}">selected</c:if>>20</option>
								<option value="50" <c:if test="${'50' eq pageInfo.pageSize}">selected</c:if>>50</option>
							</select> 条
						</div>
					</div>
